...
export class CreateAssetRequest {
    ...
    static serialize(value: CreateAssetRequest | null): Uint8Array {
        const writer = MemoryPackWriter.getSharedInstance();
        this.serializeCore(writer, value);
        return writer.toArray();
    }

    static serializeCore(writer: MemoryPackWriter, value: CreateAssetRequest | null): void {
        if (value == null) {
    ...
    static serializeArray(value: (CreateAssetRequest | null)[] | null): Uint8Array {
        const writer = MemoryPackWriter.getSharedInstance();
        this.serializeArrayCore(writer, value);
        return writer.toArray();
    }

    static serializeArrayCore(writer: MemoryPackWriter, value: (CreateAssetRequest | null)[] | null): void {
        writer.writeArray(value, (writer, x) => CreateAssetRequest.serializeCore(writer, x));
    }

    static deserialize(buffer: ArrayBuffer): CreateAssetRequest | null {
        return this.deserializeCore(new MemoryPackReader(buffer));
    }

    static deserializeCore(reader: MemoryPackReader): CreateAssetRequest | null {
        const [ok, count] = reader.tryReadObjectHeader();
        if (!ok) {
            return null;
        }

        const value = new CreateAssetRequest();
        if (count == 16) {
    ...
    static deserializeArray(buffer: ArrayBuffer): (CreateAssetRequest | null)[] | null {
        return this.deserializeArrayCore(new MemoryPackReader(buffer));
    }

    static deserializeArrayCore(reader: MemoryPackReader): (CreateAssetRequest | null)[] | null {
        return reader.readArray(reader => CreateAssetRequest.deserializeCore(reader));
    }
}
