...
export function CTASection() {
  return (
    <section data-testid="cta-section" className="section-dark relative py-24">
      <div className="container relative mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg section-muted max-w-xl mx-auto mb-10 opacity-0 animate-fade-in [animation-delay:100ms]">
