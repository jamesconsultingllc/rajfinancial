...
export function HeroSection() {
  return (
    <section data-testid="hero-section" className="section-dark relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="container relative mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main Heading */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6 opacity-0 animate-fade-in [animation-delay:100ms]">
            Take Control of Your
            <span className="block text-primary mt-2">Financial Future</span>
          </h1>

          {/* Subheading */}
          <p className="text-lg sm:text-xl section-muted max-w-2xl mx-auto mb-10 opacity-0 animate-fade-in [animation-delay:200ms]">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 opacity-0 animate-fade-in [animation-delay:300ms]">
          ...
          {/* Trust Indicators */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto opacity-0 animate-fade-in [animation-delay:400ms]">
