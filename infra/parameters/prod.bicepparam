...
param entraExternalIdInstance = 'https://rajfinancialprod.ciamlogin.com/'

// Accepted audiences for the JWT 'aud' claim.
param entraExternalIdValidAudiences = [
  'api://rajfinancial-api'
  '8914457b-06ae-447b-bbc1-f2fba572bc99'
]
